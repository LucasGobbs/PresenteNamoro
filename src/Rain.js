class Rain {
  ...
  saveOlds() {
    ...
    this.old_position = {
      x: this.drops[this.index].form.position.x,
      y: this.drops[this.index].form.position.y
    };
    this.old_size = {
      width: this.drops[this.index].form.width,
      height: this.drops[this.index].form.height
    };
  ...
  onClick() {
    if (this.start) {
      ...
      createAnimationDropSize(this.index, {
        width: this.old_size.width,
        height: this.old_size.height
      }, () => {
        createAnimationDropPosition(this.index, {
          x: this.old_position.x,
